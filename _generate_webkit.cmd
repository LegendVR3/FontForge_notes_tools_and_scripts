...
@echo on
call fontforge.bat -lang "ff" -c "Open($1); Reencode(\"unicode\"); AutoHint(); Generate($1:r + \".eot\"); Generate($1:r + \".svg\"); Generate($1:r + \".otf\"); Generate($1:r + \".ttf\"); Generate($1:r + \".woff\");" %FILE_INPUT%
...
call "%~sdp0whitespace_suffix_remover\index.cmd" "%~n1.css"
del /f /q "%~n1.css"  1>nul 2>nul
ren "%~n1__nowhitespacesuffix.css" "%~n1.css"
